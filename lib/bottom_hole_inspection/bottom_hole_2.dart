...
class BottomHole2 extends StatefulWidget {
  BottomHole2({Key key}) : super(key: key);
  @override
  _BottomHole2State createState() => _BottomHole2State();
}

class _BottomHole2State extends State<BottomHole2> {
  ...
  Widget build(BuildContext context) {
    ...
    Widget itemTableView = Container(
        child: Column(
