...
class BottomHole1 extends StatefulWidget {
  BottomHole1({Key key}) : super(key: key);
  @override
  _BottomHole1State createState() => _BottomHole1State();
}

class _BottomHole1State extends State<BottomHole1> {
                      ...
                      child: Row(
                        children: [
                          Container(
                              ...
                              child: Text('Bottom Hole Assembly Inspection',
                                  style: TextStyle(
                                    color: Colors.white,
                      ...
                      child: FlatButton(
                          onPressed: () => {
                                Navigator.of(context).pushNamed(
                                    "/bottom_hole_inspection/bottom_hole_2")
                              },
                          child: Text('Edit',
                              style: TextStyle(
                                  color: Colors.blue,
