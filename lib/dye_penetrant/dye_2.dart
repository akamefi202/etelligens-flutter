...
class Dye2 extends StatefulWidget {
  Dye2({Key key}) : super(key: key);
  @override
  _Dye2State createState() => _Dye2State();
}

class _Dye2State extends State<Dye2> {
