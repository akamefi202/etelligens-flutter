...
class MagnaticParticle2 extends StatefulWidget {
  MagnaticParticle2({Key key}) : super(key: key);
  @override
  _MagnaticParticle2State createState() => _MagnaticParticle2State();
}

class _MagnaticParticle2State extends State<MagnaticParticle2> {
  ...
  Widget build(BuildContext context) {
    ...
    Widget itemEquipement = Container(
        child: Column(
      children: [
        Row(
          crossAxisAlignment: CrossAxisAlignment.center,
    ...
    Widget itemMagnetizeMedium = Container(
        child: Column(
      children: [
        Row(
          crossAxisAlignment: CrossAxisAlignment.center,
        ...
        children: <Widget>[
                      ...
                      child: Row(
                        children: [
                          Container(
                              ...
                              child: Text('Magnetic Particle Inspection',
                                  style: TextStyle(
                                    color: Colors.white,
                                    fontSize: data.size.width * 0.018,
                                    fontWeight: FontWeight.bold,
          ...
          Container(
              ...
              child: Column(children: [
                ...
                Container(
                    // MAGNETIZING - INSPECTION EQUIPMENT
                    decoration: BoxDecoration(
                        color: Colors.white,
                        boxShadow: [
                          BoxShadow(
                      ...
                      children: [
                        Container(
                            ...
                            padding: EdgeInsets.only(
                                top: 12, bottom: 6, left: 15, right: 10),
                            margin: EdgeInsets.only(bottom: 20),
                            child: Text("MAGNETIZING - INSPECTION EQUIPMENT",
                                style: TextStyle(
                                    color: Colors.white,
                                    fontWeight: FontWeight.bold,
                                    fontSize: data.size.width * 0.0172))),
