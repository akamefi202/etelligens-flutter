...
class VisualThread2 extends StatefulWidget {
  VisualThread2({Key key}) : super(key: key);
  @override
  _VisualThread2State createState() => _VisualThread2State();
}

class _VisualThread2State extends State<VisualThread2> {
                      ...
                      child: Row(
                        children: [
                          Container(
                              ...
                              child: Text('Visual Thread Inspection',
                                  style: TextStyle(
                                    color: Colors.white,
                                    fontSize: data.size.width * 0.018,
                                    fontWeight: FontWeight.bold,
