...
class UltraSonic2 extends StatefulWidget {
  UltraSonic2({Key key}) : super(key: key);
  @override
  _UltraSonic2State createState() => _UltraSonic2State();
}

class _UltraSonic2State extends State<UltraSonic2> {
        ...
        children: <Widget>[
                      ...
                      child: Row(
                        children: [
                          Container(
                              ...
                              child: Text('Ultrasonic Inspection',
                                  style: TextStyle(
                                    color: Colors.white,
                                    fontSize: data.size.width * 0.018,
                                    fontWeight: FontWeight.bold,
          ...
          Container(
              ...
              child: Column(children: [
                ...
                Container(
                    // WALL THICKNESS READING AND MEASUREMENT
                    decoration: BoxDecoration(
                        color: Colors.white,
                        boxShadow: [
                          BoxShadow(
