...
class AirTest2 extends StatefulWidget {
  AirTest2({Key key}) : super(key: key);
  @override
  _AirTest2State createState() => _AirTest2State();
}

class _AirTest2State extends State<AirTest2> {
  ...
  Widget build(BuildContext context) {
    ...
    Widget itemEqupmentDetailWidget = Container(
        child: Column(
      children: [
        Container(
            //air compressor
                    ...
                    child: Column(
                      children: [
                        Container(
                            ...
                            child: Text("TEST EQUIPMENT DETAILS",
                                style: TextStyle(
                                    color: Colors.white,
                                    fontWeight: FontWeight.bold,
                                    fontSize: data.size.width * 0.0172))),
                        itemEqupmentDetailWidget
                      ],
                    )),
                Container(
                    ...
                    child: Column(
                      children: [
                        Container(
                            ...
                            margin: EdgeInsets.only(bottom: 20),
                            child: Text(
                                "PRESSURE STAGE AND HOLDING TIME SCHEDULE",
                                style: TextStyle(
                                    color: Colors.white,
                                    fontWeight: FontWeight.bold,
                                    fontSize: data.size.width * 0.0172))),
