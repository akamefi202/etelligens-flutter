...
class HandPower1 extends StatefulWidget {
  HandPower1({Key key}) : super(key: key);
  @override
  _HandPower1State createState() => _HandPower1State();
}

class _HandPower1State extends State<HandPower1> {
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: FlatButton(
                          onPressed: () => {
                                Navigator.of(context)
                                    .pushNamed("/hand_power/hand_power_2")
                              },
                          child: Text('Edit',
                              style: TextStyle(
                                  color: Colors.blue,
