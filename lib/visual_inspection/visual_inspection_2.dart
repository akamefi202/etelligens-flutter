...
class VisualInspection2 extends StatefulWidget {
  VisualInspection2({Key key}) : super(key: key);
  @override
  _VisualInspection2State createState() => _VisualInspection2State();
}

class _VisualInspection2State extends State<VisualInspection2> {
            ...
            child: Column(children: [
                ...
                children: [
                  Text("welds",
                      style: TextStyle(
                          ...
                          fontSize: data.size.width * 0.0197,
                          fontWeight: FontWeight.bold)),
                  Container(
                    // delete button
                    decoration: BoxDecoration(
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  Container(
                      width: 5,
                      margin: EdgeInsets.only(left: 28, right: 12),
                      child: Radio(
                        value: 1,
                        activeColor: Colors.blue,
                        groupValue: selectedRadio,
