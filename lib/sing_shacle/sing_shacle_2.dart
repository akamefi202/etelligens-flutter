...
class SingShacle2 extends StatefulWidget {
  SingShacle2({Key key}) : super(key: key);
  @override
  _SingShacle2State createState() => _SingShacle2State();
}

class _SingShacle2State extends State<SingShacle2> {
  ...
  Widget build(BuildContext context) {
    ...
    Widget itemMAGNETIZINGMETHOD = Container(
        child: Column(
      children: [
        Row(
          crossAxisAlignment: CrossAxisAlignment.center,
    ...
    Widget itemMAGNETIZINGMEDIUM = Container(
        child: Column(
      children: [
        Row(
          crossAxisAlignment: CrossAxisAlignment.center,
    ...
    Widget itemMAGNETIZINGAPPARATUS = Container(
        child: Column(
      children: [
        Row(
          crossAxisAlignment: CrossAxisAlignment.center,
                      ...
                      child: Row(
                        children: [
                          Container(
                              ...
                              child: Text('Sling/shackle inspection',
                                  style: TextStyle(
                                    color: Colors.white,
                                    fontSize: data.size.width * 0.018,
                                    fontWeight: FontWeight.bold,
                      ...
                      children: [
                        Container(
                            ...
                            padding: EdgeInsets.only(
                                top: 12, bottom: 6, left: 15, right: 10),
                            margin: EdgeInsets.only(bottom: 20),
                            child: Text("STANDARD SPECIFICATION",
                                style: TextStyle(
                                    color: Colors.white,
                                    fontWeight: FontWeight.bold,
                                    fontSize: data.size.width * 0.0172))),
                      ...
                      children: [
                        Container(
                            ...
                            padding: EdgeInsets.only(
                                top: 12, bottom: 6, left: 15, right: 10),
                            margin: EdgeInsets.only(bottom: 20),
                            child: Text("MAGNETIZING APPARATUS",
                                style: TextStyle(
                                    color: Colors.white,
                                    fontWeight: FontWeight.bold,
                                    fontSize: data.size.width * 0.0172))),
                        itemMAGNETIZINGAPPARATUS
                      ],
                    )),
                Container(
                    //MAGNETIZING METHOD
                      ...
                      children: [
                        Container(
                            ...
                            padding: EdgeInsets.only(
                                top: 12, bottom: 6, left: 15, right: 10),
                            margin: EdgeInsets.only(bottom: 20),
                            child: Text("MAGNETIZING METHOD",
                                style: TextStyle(
                                    color: Colors.white,
                                    fontWeight: FontWeight.bold,
                                    fontSize: data.size.width * 0.0172))),
                        itemMAGNETIZINGMETHOD
                      ],
                    )),
                Container(
                    // MAGNETIZING FIELD ORIENTATION
                    decoration: BoxDecoration(
                        color: Colors.white,
                        boxShadow: [
                          BoxShadow(
                      ...
                      children: [
                        Container(
                            ...
                            padding: EdgeInsets.only(
                                top: 12, bottom: 6, left: 15, right: 10),
                            margin: EdgeInsets.only(bottom: 20),
                            child: Text("MAGNETIZING FIELD ORIENTATION",
                                style: TextStyle(
                                    color: Colors.white,
                                    fontWeight: FontWeight.bold,
                                    fontSize: data.size.width * 0.0172))),
                      ...
                      children: [
                        Container(
                            ...
                            padding: EdgeInsets.only(
                                top: 12, bottom: 6, left: 15, right: 10),
                            margin: EdgeInsets.only(bottom: 20),
                            child: Text("MAGNETIZING MEDIUM",
                                style: TextStyle(
                                    color: Colors.white,
                                    fontWeight: FontWeight.bold,
                                    fontSize: data.size.width * 0.0172))),
                        itemMAGNETIZINGMEDIUM
                      ],
                    )),
                Container(
                    // TEST RESULT NOTES
