...
class TankClean2 extends StatefulWidget {
  TankClean2({Key key}) : super(key: key);
  @override
  _TankClean2State createState() => _TankClean2State();
}

class _TankClean2State extends State<TankClean2> {
